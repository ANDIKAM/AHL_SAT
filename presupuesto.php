...
if ($aceptar) { 
					...
					if ($tipo=="rp") {  if ($sucursal=="a") { $tabla="computadoras_arrecife"; $elid="id_computadoras";  }  if ($sucursal=="c") { $tabla="computadoras_centro"; $elid="id_computadoras";  }  if ($sucursal=="t") { $tabla="computadoras_tias"; $elid="id_computadoras"; } if ($sucursal=="c") { $tabla="computadoras_centro"; $elid="id_computadoras"; }     }
					if ($tipo=="rm") {  if ($sucursal=="a") { $tabla="repmovil_arrecife"; $elid="id_repmovil";  } if ($sucursal=="c") { $tabla="repmovil_centro"; $elid="id_repmovil";  }  if ($sucursal=="t") { $tabla="repmovil_tias"; }  $elid="id_repmovil";}
					if ($tipo=="lm") {  if ($sucursal=="a") { $tabla="libmovil_arrecife"; $elid="id_libmovil"; } if ($sucursal=="c") { $tabla="libmovil_centro"; $elid="id_libmovil"; }  if ($sucursal=="t") { $tabla="libmovil_tias"; } $elid="id_libmovil"; }
					if ($tipo=="rc") {  if ($sucursal=="a") { $tabla="consolas_arrecife"; $elid="id_consolas"; } if ($sucursal=="c") { $tabla="consolas_centro"; $elid="id_consolas"; }   if ($sucursal=="t") { $tabla="consolas_tias"; }  $elid="id_consolas"; }
				
				$actualizo=mysql_query("update $tabla set aprobado='si' where $elid='$numero'");
				?><script>location.href='presupuesto.php?cls=3452986159183583461908243'</script><?
				
				$mensaje="El presupuesto para la orden de reparacion  $parte ha sido aceptado"; $mensaje=utf8_encode($mensaje);
				$asunto="Presupuesto aceptado";
				$headers = "MIME-Version: 1.0\r\n"; 
				$headers .= "Content-type: text/html; charset=iso-8859-1\r\n"; 
				$headers .= "From: SAT AHL Informatica <info@ahlinformatica.com>\r\n";
				$elmail="soporte@ahlinformatica.com"; 
  ...
  <tr>
    ...
    <div style="margin-left:20px; margin-right:20px">
      ...
      <? } else {   $valido=false;
					...
					if ($tipo=="rp") {  
									    if ($sucursal=="a") { $tabla="computadoras_arrecife"; }
									    if ($sucursal=="t") { $tabla="computadoras_tias"; }
										if ($sucursal=="c") { $tabla="computadoras_centro"; } 
										...
										if ($saco[aprobado]=="si") { ?><script>location.href='satclientes.php?consultar=true&parte=<? echo $parte; ?>&dni=<? echo $dni; ?>'</script><? }
										}
										
					if ($tipo=="rm") {  if ($sucursal=="a") { $tabla="repmovil_arrecife"; }
										if ($sucursal=="t") { $tabla="repmovil_tias"; }
										if ($sucursal=="c") { $tabla="repmovil_centro"; }
				...
				if ($tipo=="lm") {      if ($sucursal=="a") { $tabla="libmovil_arrecife"; }
										if ($sucursal=="t") { $tabla="libmovil_tias"; }
										if ($sucursal=="c") { $tabla="libmovil_centro"; } 
				    ...
				    if ($tipo=="rc") {  if ($sucursal=="a") { $tabla="consolas_arrecife"; }
										...
										if ($sucursal=="c") { $tabla="consolas_centro"; } 
				 ...
				 if ($valido) {
				 				if ($tipo=="rp") { 
                                              ...
                                              <form id="form1" name="form1" method="post" action="#SELF">
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td  style="border-bottom:1px dotted #CCC"><? echo $saco[solucion]; ?></td>
                                                  </tr>
                                                  <tr>
                                                    ...
                                                    <td  style="border-bottom:1px dotted #CCC">  
														...
														if ($sucursal=="c") { $tablacomp="componentes_centro"; } 
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td height="40" class="titulo"><? if ($saco[presupuesto]!="0.00") { ?><input type="submit" name="aceptar" id="aceptar" value="Aceptar presupuesto" /><? } ?></td>
                                                  </tr>
                                                </table>
        										</form>
                                                <? } else { ?><br /><br />
                                                <div align="center"><span class="titulo">El presupuesto para esta reparación ha sido aceptado</span><br />
                                                  <br />
                                                Puede consultar el avance de su reparación desde:<br />
                                                <em><a href="http://sat.ahlinformatica.com/clientes">http://sat.ahlinformatica.com/clientes</a></em></div>
                                                <? } ?>
                                              <? }
								...
								if ($tipo=="rm") { 
                                              ...
                                              <form id="form1" name="form1" method="post" action="#SELF">
                                                  ...
                                                  <tr>
                                                    <td align="right" class="titulo"  >&nbsp;</td>
                                                    <td height="40" class="titulo"><input type="submit" name="aceptar" id="aceptar" value="Aceptar presupuesto" /></td>
                                                  </tr>
                                                </table>
        										</form>
                                                <? } else { ?><br /><br />

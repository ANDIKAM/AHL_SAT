...
if ($sucursal=="Arrecife") { $tabla_empresas=" empresas_arrecife "; }
if ($sucursal=="Tias") { $tabla_empresas=" empresas_tias "; }
if ($sucursal=="Centro") { $tabla_empresas=" empresas_centro "; } 
    ...
    <div style="margin-left:20px; margin-right:20px">
      <div style="float:right; margin-right:10px" align="right">
        <form id="form2" name="form2" method="post" action="#SELF">
          ...
          <? } else { ?>
          <a href="empresas_lista.php?or=nom">Ordenar por apellido</a>
          <? }  if ($buscar) { ?>

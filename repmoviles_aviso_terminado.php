...
if ($enviar) {  if ($sucursal=="Arrecife") { $tabla="repmovil_arrecife"; }
				...
				$mensaje="Su reparacion de movil esta terminada, puede retirar su equipo en la sucursal de AHL Informatica. Muchas gracias.";
				...
				$actualizo=mysql_query("update $tabla set sms2='si' where id_repmovil='$id'");
...
<table width="979" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div style="margin-left:20px; margin-right:20px">
      ...
      <br />
      <br />
      <? if (!$enviar) { ?><form id="form1" name="form1" method="post" action="#SELF">
      ...
      </form><? } else { echo "<br><br><br>Aguarde mientras se envía el SMS..."; } ?>
    </div>    </td>
  </tr>
  <tr>
...
<? 
 ...
 if ($enviar) {  if ($sucursal=="Arrecife") { $tabla="repmovil_arrecife"; }
				...
				?><script>location.href='repmoviles_editar.php?id=<? echo $id; ?>&cs=1'</script><?

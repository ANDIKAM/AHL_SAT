...
$fechadehoy="$ano-$mes-$dia $hora:$minuto:00";
				if ($facturar) {
								...
								if ($cls=="3") { $actualizo=mysql_query("update $tabla set estado='finalizado' where id_libmovil='$id'"); 
											     ?><script>location.href='libmoviles.php'</script><?
												} 
												
								if ($cls=="2") { $actualizo=mysql_query("update $tabla set estado='finalizado' where id_libmovil='$id'"); 
								...
								if ($cls=="1") {    $actualizo=mysql_query("update $tabla set estado='finalizado' where id_libmovil='$id'");
...
<div style="float: left;position: relative;left: 50%;">
        ...
        <div style="clear:both; width:100%;text-align: center">
            ...
            <a href="#" onClick="location.href='libmoviles_editar.php?id=<? echo $id; ?>'">No cancelar </a></p>
        </div>
        </form>
      <br />
    </div></td>

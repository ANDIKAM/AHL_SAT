...
$fechadehoy="$ano-$mes-$dia $hora:$minuto:00";
				if ($facturar) {
								...
								if ($cls=="3") { $actualizo=mysql_query("update $tabla set estado='finalizado' where id_consolas='$id'"); 
											     ?><script>location.href='consolas.php'</script><?
												} 
												
								if ($cls=="2") { $actualizo=mysql_query("update $tabla set estado='finalizado' where id_consolas='$id'"); 
								...
								if ($cls=="1") {    $actualizo=mysql_query("update $tabla set estado='finalizado' where id_consolas='$id'");
    ...
    <div style="margin-left:20px; margin-right:20px">
      ...
      <br />
        ...
        <div style="clear:both; width:100%;text-align: center">
            ...
            <a href="#" onClick="location.href='consolas_editar.php?id=<? echo $id; ?>'">No cancelar </a></p>
        </div>
        </form>
      <br />
    </div></td>

...
if ($eliminar) {
				$ingreso=mysql_query("delete from news_empresas where id_news='$id'"); 
				?><script>location.href='empresas_news.php?ssid=<? echo rand(111111,999999); ?>'</script><? }
 ?>
...
<table width="979" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div style="margin-left:20px; margin-right:20px">
      <h1>Newsletter &raquo; Eliminar</h1>
      <br />
      <form id="form1" name="form1" method="post" action="#SELF">
        <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center">¿ Está seguro que desea eliminar el Newsletter?<br />
              <br />

...
$fechadehoy="$ano-$mes-$dia $hora:$minuto:00";
				if ($facturar) {
								...
								if ($cls=="3") { $actualizo=mysql_query("update $tabla set estado='finalizado' where id_computadoras='$id'"); 
											     ?><script>location.href='computadoras.php'</script><?
												} 
												
								if ($cls=="2") { $actualizo=mysql_query("update $tabla set estado='finalizado' where id_computadoras='$id'"); 
													...
													if ($sucursal=="Arrecife") { $tabla_facturas="facturas_arrecife"; }
														...
														$ingresofactura=mysql_query("insert into $tabla_facturas (fecha, cliente, total, tipo, caso, aprobado, tienda, forma) values ('$fechadehoy', '$idcl', '12', '$tipo', '$id', 'no', '$sucursal','$forma')");
								...
								if ($cls=="1") {    $actualizo=mysql_query("update $tabla set estado='finalizado' where id_computadoras='$id'");
													...
													$ingresofactura=mysql_query("insert into $tabla_facturas (fecha, cliente, total, tipo, caso, aprobado, tienda, forma) values ('$fechadehoy', '$idcl', '$totalrep', '$tipo', '$id', 'si', '$sucursal', '$forma')");
...
<div style="float: left;position: relative;left: 50%;">
        ...
        <div style="clear:both; width:100%;text-align: center">
            ...
            <a href="#" onClick="location.href='computadoras_editar.php?id=<? echo $id; ?>'">No cancelar </a></p>
        </div>
        </form>
      <br />
    </div></td>

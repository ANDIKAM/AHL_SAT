...
if ($eliminar) { $elimino=mysql_query("delete from empresa_presupuesto_detalle where id_empresa_presupuesto_detalle='$id_art'");  
      ...
      <form id="form1" name="form1" method="post" action="">
        <div align="center">¿ Está seguro que desea eliminar el item ?
          <br />
            ...
            &nbsp;&nbsp;&nbsp;<a href="#" onClick="location.href='ventas.php'">No, cancelar</a>          </div>
      </form>
      </div>    </td>
  </tr>
  <tr>

...
<table width="979" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div style="margin-left:20px; margin-right:20px">
      <h1>Empresas &raquo; <? $b=mysql_query("select * from $tabla_empresas where id_empresa='$id'"); $s=mysql_fetch_array($b);  ?><a href='empresas_editar.php?id=<? echo $id; ?>'><? echo $s[nombre]; ?></a> &raquo; ver presupuesto</h1>

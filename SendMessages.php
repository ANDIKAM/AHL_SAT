...
include_once('lib/virtualsms.php');
include_once('lib/constants.php');

error_reporting(E_ALL);

define('SMS_USER', 'TEST210829');
define('SMS_PASS', '1LtVj1');
...
if (!class_exists('SendMessages')) {
    ...
    class SendMessages extends Events {
        ...
        function SendMessages() {
            ...
            $protololProperties = new ProtocolProperties();
            $protololProperties->setHost('sms2.lleida.net');
            $this->sms->setProtocolProperties($protololProperties);

...
function confirmar_envio_news(id_empresa, nombre_empresa) {
												 if (confirm('Está seguro que desea enviar el Newsletter a '+nombre_empresa)) { location.href='empresas_news_enviar_simple_clientes.php?id=<? echo $id; ?>&id_empresa='+id_empresa; }
												}
...
<table width="979" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div style="margin-left:20px; margin-right:20px">
      <h1>Newsletter</h1>
      <? if ($id_empresa=="") { ?>
      <br />Seleccionar Cliente<br />
      <br />
      <table id="DataTabla" style="border:1px solid #E5E5E5" width="930" border="0" cellspacing="3" cellpadding="3">
        <thead>
          <tr>
          <td height="30" bgcolor="#DBDBDB">Nombre</td>
          <td width="200" height="30" align="center" bgcolor="#DBDBDB">E-mail</td>
          </tr>
        </thead>
        <tbody>
        <? 
		 $busco=mysql_query("select * from clientes where email1!='' order by apellido, nombre"); 
		...
		?>
        <tr >
          <td <? echo $link; echo $fondo; ?>><? echo "$saco[apellido] $saco[nombre]"; ?></td>
          <td nowrap="nowrap" <? echo $link; echo $fondo; ?>><? echo $saco[email1]; ?>&nbsp;</td>
          </tr>
        <? } ?>
      </tbody>
      </table>
      <? } else {
							...
							$b=mysql_query("select * from clientes where id_clientes='$id_empresa'");
...
<hr> <strong>Para dejar de recibir nuestra publicidad, es suficiente con hacer click en el siguiente link:</strong><br><a href='$link'>$link</a>";
			...
			?><div style="margin:10px; padding:10px; background-color:#FFFFCC; border: 1px dotted #999; text-align:center">El Newsletter se ha enviado a <strong><? echo $destinatario; ?></strong> <br /><br />
      <a href='empresas_news.php'>&laquo; Volver...</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='empresas_news_enviar_simple_clientes.php?id=<? echo $id; ?>'>&raquo; Enviar a otro cliente...</a></div><?				

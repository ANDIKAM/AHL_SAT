		...
		if ($sucursal=="Centro") { $tabla="consolas_centro"; } 
				...
				if ($s[movil1]!="") { 
										...
										$txt = "El presupuesto de su reparacion esta terminado, puede verificarlo en http://sat.ahlinformatica.com/clientes";
                                                                                $cod="RC".($saco[tienda]=="Tias"?"T":($saco[tienda]=="Centro"?"C":($saco[tienda]=="Arrecife"?"A":""))).str_pad($saco[0], 5, "0", STR_PAD_LEFT);
				...
				$actualizo=mysql_query("update $tabla set sms='si' where id_consolas='$id'");
				
				?><script>location.href='consolas_editar.php?id=<? echo $id; ?>'</script><?
    ...
    <div style="margin-left:20px; margin-right:20px">
      ...
      <form id="form1" name="form1" method="post" action="#SELF">
        <div align="center">¿ Está seguro que desea enviar el aviso de presupuesto terminado ?<br />
          ...
          &nbsp;&nbsp;&nbsp;<a href="#" onClick="location.href='consolas_editar.php?id=<? echo $id; ?>'">No, cancelar </a></div>
      </form>
    </div>    </td>
  </tr>
  <tr>

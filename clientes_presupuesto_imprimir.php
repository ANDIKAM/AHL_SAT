...
if ($logadmin) { 
 ...
 $bn=mysql_query("select * from clientes where id_clientes='$laempresa'");
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div style="float:right;"><strong>Cliente:</strong> <a href="#"><? echo "$sn[apellido] $sn[nombre]"; ?></a></div></div><br />
...
<script language="JavaScript">window.print();  window.setTimeout("location.href='clientes_editar.php?id=<? echo $id; ?>';",1000);  </script> 
</body>
</html>
